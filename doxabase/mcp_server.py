...
def build_server(capsule_path: str | Path = ".doxabase.sqlite") -> FastMCP:
    ...
    @server.tool(name="doxabase.record_domain_network_profile")
    def record_domain_network_profile(
        ...
        """Record reviewed aggregate domain-network profile counts."""

        return record_domain_network_profile_tool(
            db,
            dataset_iri=dataset_iri,
            summary=summary,
            evidence_summary=evidence_summary,
    ...
    def record_analysis_packet(
        ...
        query_recipes: list[dict[str, Any]] | None = None,
    ...
    def record_map_table_bundle(
        ...
        """Record a table, columns, and optional storage/layout map facts."""

        return record_map_table_bundle_tool(
            db,
            iri=iri,
            label=label,
            description=description,
    ...
    @server.tool(name="doxabase.record_profiled_parquet_table")
    def record_profiled_parquet_table(
        ...
        """Record reviewed Parquet table metadata and profile observations."""

        return record_profiled_parquet_table_tool(
            db,
            iri=iri,
            dataset_summary=dataset_summary,
            evidence_summary=evidence_summary,
