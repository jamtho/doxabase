...
6. Use `doxybase.record_observation` when you discover a point-in-time finding that should remain available to later agents.
7. Use `doxybase.validate_graph` when you need an explicit SHACL diagnostic.
...
It does expose structured observation recording for routine findings.
