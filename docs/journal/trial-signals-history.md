# Field Trial Product Signals — Historical Journal

Moved verbatim from `docs/agent/field-trials.md` (distillation Phase 6.1,
2026-07-04): dated trial narratives are journal material, not agent
reference. Newest entries were appended at the end.
