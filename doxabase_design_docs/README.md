...
- `10-next-directions.md` — post-program direction proposal: recorded-trials/deferred-distiller loop, real-work field sessions, capsule report + worked examples, ontology-pack generalisation.
